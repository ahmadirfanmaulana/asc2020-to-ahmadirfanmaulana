...
@section('content')
    ...
    @include('layouts.toolbar2')
        ...
        <form class="needs-validation" novalidate action="{{route('sessions.store', ['event' => $event->id])}}" method="POST">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="inputTitle" name="title" placeholder="" value="{{old('title')}}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="inputSpeaker" name="speaker" placeholder="" value="{{old('speaker')}}">
                </div>
            </div>
